...
exports.setPriority = exports.removeItem = exports.getShoppingList = exports.getCompletedList = exports.clearCompleted = exports.addToShoppingList = exports.addItemToCompleted = void 0;
//data modification 
...
const addItemToCompleted = itemId => {
  const findItem = shoppingList.find(({
    id
  }) => id === itemId);
  shoppingList = shoppingList.filter(({
    id
...
exports.addItemToCompleted = addItemToCompleted;
...
},{}],"js/veiw.js":[function(require,module,exports) {
"use strict";
...
completedDiv.addEventListener('drop', function (evt) {
  ...
  if (itemId) {
    ...
    (0, _model.addItemToCompleted)(itemId);
    //updating shopping list
    (0, _veiw.renderShoppingList)();
    //update Completed task list
    (0, _veiw.renderCompletedList)();
  }
});
...
},{"./Item":"js/Item.js","./model":"js/model.js","./veiw":"js/veiw.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
